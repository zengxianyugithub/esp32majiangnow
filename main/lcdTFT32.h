...
#define GPIO_OUTPUT_IO_LCD_RST    16
...
#define GPIO_OUTPUT_IO_LCD_CS    4
#define GPIO_OUTPUT_IO_LCD_RST    5
#define GPIO_OUTPUT_IO_LCD_SCL    16
#define GPIO_OUTPUT_IO_LCD_SDA   17
*/
#define GPIO_OUTPUT_PIN_SEL  ((1ULL<<GPIO_OUTPUT_IO_LCD_BLK) | (1ULL<<GPIO_OUTPUT_IO_LCD_RS)| (1ULL<<GPIO_OUTPUT_IO_LCD_CS)| (1ULL<<GPIO_OUTPUT_IO_LCD_RST)| (1ULL<<GPIO_OUTPUT_IO_LCD_SCL)| (1ULL<<GPIO_OUTPUT_IO_LCD_SDA))
